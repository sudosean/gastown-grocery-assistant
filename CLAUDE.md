...
**YOU ARE IN: `groceryAssistant/polecats/shiny/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/groceryAssistant/` (rig root) or other directories
...
**Your mail address:** `groceryAssistant/polecats/shiny`
**Your rig:** groceryAssistant
**Your Witness:** `groceryAssistant/witness`
...
| Ask Witness for help | `gt mail send groceryAssistant/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`groceryAssistant/witness`) when:
...
```bash
gt mail send groceryAssistant/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
